...
def mfblmXprod(matEin, QNs = None, EPRX = None, EPRXresort = None, p=None, ep=None, BLMtable = None, BLMtableResort = None,
    ...
    05/03/24    Updating for arb pol case (p!=0)
                    - Allow passing of `ep`.
    ...
    *** Optional input data/basis functions (mainly for fitting routine use)
    ...
    p : list or array, optional, default = None
        ...
        UPDATE 06/03/24: now supports all p terms via ep values, default p=[-1,0,1]
    ...
    **kwargs, unused but allows for arb basis dict unpack and passing from other functions.
    ...
    # 06/03/24: for updated EPR including ep terms.
...
#     BLMXout = BLMXout/BLMXout.XS  # Normalise
    ...
    # Return basis arrays/tensors
        ...
        basis = {'QNs':QNs, 'EPRX':EPRXresort, 'lambdaTerm':lambdaTermResort,
                ...
                'phaseConvention':phaseConvention, 'phaseCons':phaseCons, 'polProd':polProd}
