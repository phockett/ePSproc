...
- April/May 2024:
  - Implemented basic ADM class, `ep.classes.ADM` (aba18dcc04e8c111fd6b1d18173789a3fe0e4d5e), and allow passing to AFPAD routine (ccea2599f0980082cee8d76736f909c25ab87f3d).
  - Various updates and debugs to Efield class and handling.
  - Updated docs, in particular [Frame definitions and MF, AF calc examples](https://epsproc.readthedocs.io/en/3d-afpad-dev/special_topics/frame_definitions_docs_130323.html) (3dad8c5a862a7122d0887d76bb61308d911e053b).
- June/July 2024
  - Implement state-resolved gamma calcs:
    - For legacy codes, IO from file plus calculations (f4000c947e33b377c9dbe5b8e2c139aa26d36608), [and docs](https://epsproc.readthedocs.io/en/3d-afpad-dev/methods/state-resolved_gamma_legacy_demo_170724.html).
    - New python implementation for C and gamma calcs (b22bbbfda77b825b7af94527d2fe9244f09f7f3c), [and docs](https://epsproc.readthedocs.io/en/3d-afpad-dev/methods/state-resolved_gamma_python_demo_190724.html).
    - Nov. 2024: fix various issues with 1/2-int angular momenta (ffa0eb4be0a4e67ab7d632a05a8d8218ef84d160), including QN assignment and forcing Sympy backend for Wigner3j calcs for 1/2-int case. Added `spinWeightings()` function (0d5d0fbb5db8d560a8455a941846a246e56186f2) and integrated & debugged (dd481b00d6ee91e005db96e277650ef91e60367a)
  - Implement general density matrix from spherical tensor calculation, `ep.calc.density.densityFromSphTensor()` (e2dcdd326e6e144fb4c442383ee096353314b17f), and added to [general density matrix docs](https://epsproc.readthedocs.io/en/3d-afpad-dev/methods/density_mat_notes_demo_300821.html).
...
- 27/05/24 Added `autoapi` to Sphinx/RTD builds (c642abdb85e995880c8da1675783532e43ca7fc0). (See https://github.com/readthedocs/sphinx-autoapi for details.)
